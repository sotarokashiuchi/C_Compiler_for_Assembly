...
- [x] (2023/07/08)「compilerbook:3：トークナイザを導入」
  ...
  - [ ] (保留)グローバル変数の定義方法を学ぶ
    - グローバル変数を使用せずに実装することができたため一時保留
  - [x] (2023/07/08)トークナイズする
- [ ] 「compilerbook:5：四則演算のできる言語の作成」
  - [ ] 全ての関数をABI規約に合うようにする(レジスタの退避等)
  - [ ] 抽象構文木を作成し、加減算を実現する
  - [ ] 抽象構文木を作成し、四則演算を実現する
  - [ ] 抽象構文木を作成し、括弧を含む四則演算を実現する
...
- [ ] 第2章:実験してみよう―Cはメモリをどう使うのか
  ...
  - [ ] 7:アラインメント
  - [ ] 8:バイトオーダー
  - [ ] 9:言語仕様と実装について―ごめんなさい，ここまでの内容はかなりウソです
- [ ] 第3章:Cの文法を解き明かす―結局のところ，どういうことなのか？
  ...
  - [ ] 4:続・Cの宣言を解読する
  - [ ] 5:その他
  - [ ] 6:頭に叩き込んでおくべきこと―配列とポインタは別物だ!!
- [ ] 第4章:定石集―配列とポインタのよくある使い方
  - [ ] 1:基本的な使い方
  - [ ] 2:組み合わせて使う
- [ ] 第5章:データ構造―ポインタの真の使い方
  - [ ] 1:ケーススタディ1:単語の使用頻度を数える
  - [ ] 2:ケーススタディ2:ドローツールのデータ構造
- [ ] 第6章:その他―落ち穂拾い
  - [ ] 1:新しい関数群
  - [ ] 2:落とし穴
  - [ ] 3:イディオム
